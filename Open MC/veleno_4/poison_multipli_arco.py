...
def main():
    ...
    moltiplicatori_to_test = [1.250 , 1.875 , 2.250 ] # <-- INSERISCI QUI I MOLTIPLICATORI DA TESTARE
    ...
    for moltiplicatore in moltiplicatori_to_test:
        ...
        try:
            ...
            giorni_on_burnup = [30.0, 50 , 100, 50, 100, 49.5 , 0.5 ]
            giorni_off = [0.05, 0.1 , 0.15 , 0.2, 0.5, 1, 3 , 3 ,3 ,3]
