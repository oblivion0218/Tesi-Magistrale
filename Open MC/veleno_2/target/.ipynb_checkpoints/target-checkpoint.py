...
tally_isotropy = openmc.Tally(name='distribuzione_ang_sfera')
...
tally_isotropy_ene = openmc.Tally(name='distribuzione_energy_sfera')
tally_isotropy_ene.filters = [surface_filter_sphere, particle_filter, energy_filter]
tally_isotropy_ene.scores = ['current']
tallies.append(tally_isotropy_ene)
