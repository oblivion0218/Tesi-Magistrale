...
\begin{frame}{The Global Energy Challenge}
    \begin{columns}[T] % [T] allinea le colonne in alto
        ...
        \begin{column}{0.50\textwidth}
            ...
            \textcolor{blue!80!black}{\textbf{Climate Emergency}} \\
            Record CO$_2$ emissions and global warming drive the urgent need for decarbonization. 
            Most of worldwide electricity still relies on fossil fuels, while energy demand is constantly increasing.

            \vspace{0.2cm}
            \textcolor{blue!80!black}{\textbf{A Possible Solution}} \\
            Transitioning to a \textbf{carbon-free baseload} requires innovative technologies. \textbf{Accelerator-Driven Systems} provide a unique solution:
            \vspace{0.1cm}
            \begin{itemize}
                \item Inherent safety due to subcritical operation
                \item Power modulation via beam intensity
            \end{itemize}
        ...
        \begin{column}{0.45\textwidth}
            \vspace{0.2cm} % Regola questo valore per centrare l'immagine verticalmente
            
            \begin{figure}
                \centering
                \includegraphics[width=\textwidth]{caldo.png}
                \vspace{0.1cm}
                \footnotesize{Intense heat wave over Europe in the final days of June 2026.}
            \end{figure}
...
\begin{frame}{Lattice Pitch Optimization}
    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.4\textwidth}
            \begin{itemize}
                \item \textbf{Green Zone:} Possible operation — target $k_{max}$ reachable by modulating enrichment while the \textbf{Red Zone} is inaccessible,  $k_{max}$ is not reached even at 50\% enrichment
...
\begin{frame}{Stable Solution Space for a 3.551 cm Pitch}
    \begin{figure}
        \centering
        \includegraphics[width=0.78\textwidth]{regressione_parabolica_filtrata.png}
        \caption{Locus of stable operating points}
        \label{fig:stabilità}
    \end{figure}
\end{frame}
...
\begin{frame}{Extracted Power Variation}
    \begin{figure}
        \centering
        \includegraphics[width=0.7\textwidth]{deriva_massa_u235.png}
        \label{fig:uranium}
    \end{figure}
\end{frame}
